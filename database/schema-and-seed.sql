...
INSERT INTO users (name, email, password_hash, role, is_active) VALUES
    ('Admin Utama', 'admin@ordina.test', '$2y$10$REPLACE_WITH_GENERATED_HASH', 'Admin', 1),
    ('Sales Satu', 'sales1@ordina.test', '$2y$10$REPLACE_WITH_GENERATED_HASH', 'Sales', 1),
    ('Sales Dua', 'sales2@ordina.test', '$2y$10$REPLACE_WITH_GENERATED_HASH', 'Sales', 1),
    ('Gudang Satu', 'wh1@ordina.test', '$2y$10$REPLACE_WITH_GENERATED_HASH', 'WarehouseStaff', 1),
    ('Gudang Dua', 'wh2@ordina.test', '$2y$10$REPLACE_WITH_GENERATED_HASH', 'WarehouseStaff', 1);
